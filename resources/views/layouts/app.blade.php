...
<div class="app-shell">
    ...
    <div class="app-main">
        ...
        <header class="app-topbar">
            <button class="btn btn-link d-lg-none topbar-toggle" @click="document.querySelector('.app-sidebar').classList.toggle('open')">
            ...
            <div class="topbar-actions ms-auto">
                ...
                <div class="user-chip ms-2">
                    <div class="user-avatar">
                        @php
                            $name = match(true) {
                                isset($authUser) && method_exists($authUser, 'getAttribute') && $authUser->first_name ?? false => $authUser->first_name,
