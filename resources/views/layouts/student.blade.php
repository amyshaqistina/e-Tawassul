...
@section('sidebar')
    ...
    <a href="{{ route('student.crisis.create') }}" class="nav-link {{ request()->routeIs('student.crisis.create') ? 'active' : '' }}">
        <i class="bi bi-plus-circle"></i> Submit a Report
    </a>
    <div class="nav-section">Legacy Messages</div>
    <a href="{{ route('student.ldms.index') }}" class="nav-link {{ request()->routeIs('student.ldms.*') && !request()->routeIs('student.ldms.create') ? 'active' : '' }}">
        <i class="bi bi-envelope-paper"></i> My Messages
    </a>
    <a href="{{ route('student.ldms.create') }}" class="nav-link {{ request()->routeIs('student.ldms.create') ? 'active' : '' }}">
