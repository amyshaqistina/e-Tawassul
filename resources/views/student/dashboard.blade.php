...
@section('content')
    <style>
        ...
        .privacy-notice-body li:last-child {
        ...
        .action-card.legacy::before {
            background: #1a56db;
        }

        .action-card.crisis::before {
            background: #ea580c;
        }
        ...
        .action-card.legacy .action-card-btn {
            background: #1a56db !important;
        }

        .action-card.legacy .action-card-btn:hover {
            background: #1245b8 !important;
            color: #fff !important;
        }

        .action-card.crisis .action-card-btn {
            background: #ea580c !important;
        }

        .action-card.crisis .action-card-btn:hover {
        ...
        .stat-tile.tile-primary .stat-tile-icon {
            background: #eff6ff !important;
            color: #1a56db !important;
        }

        .stat-tile.tile-success .stat-tile-icon {
            background: #ecfdf5 !important;
            color: #059669 !important;
        }

        .stat-tile.tile-warning .stat-tile-icon {
        ...
        <div class="action-cards-row">
            <div class="action-card legacy">
                ...
                <div class="action-card-body">
                    ...
                    <p>Create a secure farewell message (wasiat) to be delivered to designated recipients only upon verified
            ...
            <div class="action-card crisis">
                ...
                <div class="action-card-body">
                    ...
                    <p>Report accidents, illness, or emergencies. Your report will be securely verified and processed by
                        university staff.</p>
            ...
            <div class="col-lg-7">
                <div class="content-card">
                    ...
                    @forelse($reports as $r)
                        <div class="list-row">
                            <div>
                                <div class="fw-semibold">Report #{{ $r->report_id }} —
                                    {{ ucwords(str_replace('_', ' ', $r->crisis?->crisis_type ?? '')) }}</div>
                            ...
                            <div class="text-end">
                                ...
                                <div><a href="{{ route('student.crisis.show', $r->report_id) }}"
                                        class="btn btn-link btn-sm">View</a></div>
                            </div>
                        </div>
                    @empty
                ...
                <div class="content-card">
                    ...
                    @forelse($notifications as $n)
                        <a href="{{ $n->link ?? route('notifications.index') }}"
                            class="notification-row text-decoration-none">
                            <div class="fw-semibold">{{ $n->subject }}</div>
                            <small
                                class="text-muted d-block">{{ \Illuminate\Support\Str::limit($n->notification_message, 80) }}</small>
